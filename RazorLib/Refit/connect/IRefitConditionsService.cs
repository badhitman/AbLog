...
public interface IRefitConditionsService
{
    ...
    [Get($"/api/{GlobalStatic.HttpRoutes.Conditions}/{{owner_id}}/{{condition_type}}")]
    ...
    [Post($"/api/{GlobalStatic.HttpRoutes.Conditions}/{GlobalStatic.HttpRoutes.UPDATE}")]
    ...
    [Delete($"/api/{GlobalStatic.HttpRoutes.Conditions}/{{condition_id}}/{{condition_type}}")]
