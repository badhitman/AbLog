...
public class HardwiresMqttService(IMqttBaseService mqtt, MqttConfigModel mqtt_conf) : IHardwiresService
{

    /// <inheritdoc/>
    public async Task<TResponseModel<List<HardwareModel>>> HardwiresGetAll(CancellationToken cancellation_token = default)
    {
        TResponseModel<List<HardwareModel>> res = new();
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(new NoiseModel(), $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Hardwires}/{GlobalStatic.Routes.LIST}", cancellation_token);
        ...
        TResponseModel<List<HardwareModel>>? response_mqtt = JsonConvert.DeserializeObject<TResponseModel<List<HardwareModel>>>(rpc.Response);
    ...
    public async Task<HttpResponseModel> GetHardwareHtmlPage(HardwareGetHttpRequestModel req, CancellationToken cancellation_token = default)
    {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(req, $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Hardwires}/{GlobalStatic.Routes.HTTP}", cancellation_token);
    ...
    /// <inheritdoc/>
    public async Task<TResponseModel<HardwareBaseModel>> HardwareGet(int hardware_id, CancellationToken cancellation_token = default)
    {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(new SimpleIdNoiseModel() { Id = hardware_id }, $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Hardware}/{GlobalStatic.Routes.GET}", cancellation_token);
        ...
        TResponseModel<HardwareBaseModel>? response_mqtt = JsonConvert.DeserializeObject<TResponseModel<HardwareBaseModel>>(rpc.Response);
    ...
    public async Task<TResponseModel<EntryModel>> CheckPortHardware(PortHardwareCheckRequestModel req, CancellationToken cancellation_token = default)
    {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(req, $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Port}/{GlobalStatic.Routes.CHECK}", cancellation_token);
        ...
        TResponseModel<EntryModel>? response_mqtt = JsonConvert.DeserializeObject<TResponseModel<EntryModel>>(rpc.Response);
    ...
    {
        TResponseModel<PortHardwareModel> res = new();
        if (port_id <= 0)
        {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(new SimpleIdNoiseModel() { Id = port_id }, $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Port}/{GlobalStatic.Routes.GET}", cancellation_token);
        ...
        TResponseModel<PortHardwareModel>? response_mqtt = JsonConvert.DeserializeObject<TResponseModel<PortHardwareModel>>(rpc.Response);
    ...
    public async Task<ResponseBaseModel> SetNamePort(EntryModel port_id_name, CancellationToken cancellation_token = default)
    {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(port_id_name, $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Port}/{GlobalStatic.Routes.UPDATE}", cancellation_token);
    ...
    public async Task<ResponseBaseModel> HardwareDelete(int hardware_id, CancellationToken cancellation_token = default)
    {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(new SimpleIdNoiseModel() { Id = hardware_id }, $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Hardware}/{GlobalStatic.Routes.DELETE}", cancellation_token);
    ...
    public async Task<TResponseModel<List<EntryModel>>> HardwiresGetAllAsEntries(CancellationToken cancellation_token = default)
    {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(new NoiseModel(), $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Hardware}/{GlobalStatic.Routes.ENTRIES}", cancellation_token);
        ...
        TResponseModel<List<EntryModel>>? response_mqtt = JsonConvert.DeserializeObject<TResponseModel<List<EntryModel>>>(rpc.Response);
    ...
    {
        TResponseModel<List<EntryNestedModel>> res = new();

        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(new NoiseModel(), $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Hardware}/{GlobalStatic.Routes.NESTED_ENTRIES}", cancellation_token);
        ...
        TResponseModel<List<EntryNestedModel>>? response_mqtt = JsonConvert.DeserializeObject<TResponseModel<List<EntryNestedModel>>>(rpc.Response);
    ...
    public async Task<TResponseModel<HardwareBaseModel>> HardwareUpdate(HardwareBaseModel hardware, CancellationToken cancellation_token = default)
    {
        ...
        TResponseModel<string> rpc = await mqtt.MqttRemoteCall(hardware, $"{mqtt_conf.PrefixMqtt}{GlobalStatic.Routes.Hardware}/{GlobalStatic.Routes.UPDATE}", cancellation_token);
