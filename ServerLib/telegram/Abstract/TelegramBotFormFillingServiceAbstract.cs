...
/// </summary>
public abstract class TelegramBotFormFillingServiceAbstract : ITelegramBotFormFillingService
{
    /// <summary>
    ...
    /// Logger
    /// </summary>
    public required ILogger<TelegramBotFormFillingServiceAbstract> Logger { get; set; }
