...
Есть рабочий [пример файла](https://github.com/badhitman/AbLog/blob/main/old.v3/AbLogServer.Server/ab-log.service) демона под Linux, но вы можете сконфигурировать службу по своему усмотрению.
