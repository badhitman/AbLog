...
public class ConditionsController(IConditionsService Conditions) : ControllerBase
{
    ...
    public async Task<TResponseModel<List<ConditionAnonymModel>>> ConditionsGetByOwner([FromRoute] int owner_id, [FromRoute] ConditionsTypesEnum condition_type, CancellationToken cancellation_token = default)
    ...
    public async Task<TResponseModel<List<ConditionAnonymModel>>> ConditionDelete([FromRoute] int condition_id, [FromRoute] ConditionsTypesEnum condition_type, CancellationToken cancellation_token = default)
