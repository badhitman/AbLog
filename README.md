...
предыдущая версия в отдельной ветке [version_3](https://github.com/badhitman/AbLog/tree/version_3)
...
## План
- [x] Локальный WEB сервер+клиент для серверной части
- [x] Клиент удалённого доступа к серверу (MAUIBlazor Hybrid)
