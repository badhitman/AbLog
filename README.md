...
4. Получение уведомлений от удалённой системы. Штатные клиенты удалённого доступа в этом плане пасивны. Когда они не запущены - они не имеют ни какой связи с сервером.
